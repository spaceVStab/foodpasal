        ...
        <div className="flex flex-col gap-5">
            { props.foodList.map((foodPerCategory, index) => (
                <div className="flex flex-col gap-5" id={foodPerCategory.category_name}>
                    <p className="text-2xl self-center text-center bg-red-500 text-white border-2 border-red-500 rounded-full ml-5 w-80 mr-5 font-semibold">{foodPerCategory.category_name}</p>
